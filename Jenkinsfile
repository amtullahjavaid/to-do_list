...
pipeline {
    agent {
        docker {
            ...
            args '-v jenkins_docker_certs:/certs/client -v jenkins_docker:/var/lib/docker --privileged'
        }
    }
            ...
            steps {
                script {
                    sh '''
                        ...
                        # Run selenium tests against the deployed application
                        docker run --rm --network host selenium-tests:latest || true
                    '''
                }
            }
        }
        ...
        always {
            script {
                sh '''
                    ...
                    # Cleanup docker system (commented out to avoid removing other images)
